...
class SecurityMemberListScreen extends StatefulWidget {
  const SecurityMemberListScreen({super.key});
  static const String routePath = '/adminControls/securityMember';

  @override
  State<SecurityMemberListScreen> createState() =>
      _SecurityMemberListScreenState();
}

class _SecurityMemberListScreenState extends State<SecurityMemberListScreen> {
  ...
  loadUsers() async {
    UserListModel model = await _api.getUsersByRole('GUARD');
          ...
          TextButton(
            onPressed: () async {
              Navigator.of(context)
                  .pushNamed(CreateSecurityMember.routePath)
                  .then((value) {
                loadUsers();
              });
            },
        ...
        Expanded(
          child: ListView.separated(
              itemBuilder: (context, index) => ListTile(
                    ...
                    subtitle: Text(
                      '${userList.elementAt(index).designation}',
